...
#=================================================================DATABASE_AREA=============================================================================#
con=MC.connect(user="root",host="localhost",password="Amma5657")
curs=con.cursor()
curs1=con.cursor()
curs2=con.cursor()
...
def Students(x,y,z,X,Y):
    ...
    Home2.geometry()
    #Frames
    Main=Frame(Home2, width=1265,bd=10,padx='50',bg=X,relief=RIDGE)
    Main.pack(side=TOP)
    ...
    due.pack()
    Butt=Frame(Main,width=1265,height=100,bd=10,bg=X,relief=RIDGE)
    Butt.pack()
    #Pros
    de=date.today()
    ...
    kgf=Label(Time,font=("futura",19,"bold"),text="Date:"+fg,fg=Y,bg=X).grid(row=0,column=0,sticky=W)
    li=datetime.now()
    vy=li.strftime("%H:%M")
    kgf1=Label(Time,font=("futura",19,"bold"),text="Last Altered:"+vy,bg=X,fg=Y).grid(row=1,column=0,sticky=W)
    if(x=="Staff"):
        si=Label(Secinf,font=("futura",19,"bold"),text="          "+x+"       ",bg=X,fg=Y).grid(row=0,column=1,sticky=W)
        si1=Label(Secinf,font=("futura",19,"bold"),text="         "+y+"   ",bg=X,fg=Y).grid(row=1,column=1,sticky=W)
    else:
        si=Label(Secinf,font=("futura",15,"bold"),text="Class:"+"\t"+x+"\t",bg=X,fg=Y,pady=3).grid(row=0,column=11,sticky=W)
        si1=Label(Secinf,font=("futura",15,"bold"),text="Sec:"+"\t"+y+"\t",bg=X,fg=Y,pady=3).grid(row=1,column=11,sticky=W)
    si11=Label(Title11,font=("futura",28,"bold"),text="                         Library Data Recorder        \t",bg=X,fg=Y).grid(row=1,column=11,sticky=W,padx=10,pady=10)
    JGD=Label(Title,font=("futura",12,"bold"),text="JAI GURU DEV",bg=X,fg=Y).pack()
    ...
    JGD9=Label(due,font=("futura",18,"bold"),text="Today's Due:  ",bg=X,fg=Y).grid(row=1,column=0)
    ...
    add=Button(Butt,text="ADD",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[sad(),Students(x,y,z,X,Y),Home2.destroy()])
    add.grid(row=0,column=0,padx='5',pady='5')
    go=Button(Butt,text="SETTINGS",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[Settings(Home2,X,Y)])
    go.grid(row=0,column=40,padx='5',pady='5')
    delete=Button(Butt,text="CLEAR",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[clear(),Home2.destroy(),Students(x,y,z,X,Y)])
    delete.grid(row=0,column=1,padx='5',pady='5')
    fst1=Button(Butt,text="ADD BOOK",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[Books(X,Y),Home2.destroy()])
    fst1.grid(row=0,column=11,padx='5',pady='5')
    exi=Button(Butt,text="QUIT",font=("futura",19,"bold"),padx=5,pady=5,bd=10,bg="red",command=lambda:[qui()])
    exi.grid(row=0,column=500,padx='5',pady='5')
    fst=Button(Butt,text="CHANGE LOGIN",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[Login_selection(X,Y),Home2.destroy()])
    fst.grid(row=0,column=3,padx='5',pady='5')
...
def Login_selection(X,Y):
    ...
    DisplayR=Text(Title1,font=('arial',12,'bold'),width=23,height=10)
    DisplayR.grid(row=1,column=0)
    DisplayR1=Text(Title1,font=('arial',12,'bold'),width=10,height=10)
    DisplayR1.grid(row=1,column=1)
    DisplayR2=Text(Title1,font=('arial',12,'bold'),width=23,height=10)
    DisplayR2.grid(row=1,column=2)
    DisplayR3=Text(Title1,font=('arial',12,'bold'),width=10,height=10)
    DisplayR3.grid(row=1,column=3)
    DisplayR4=Text(Title1,font=('arial',12,'bold'),width=6,height=10)
...
def Books(X,Y):
        ...
        JGD=Label(Title,font=("futura",12,"bold"),text="JAI GURU DEV",bg=X,fg=Y).pack()
        Head=Label(Title,font=("futura",45,"bold"),text="             MAHARISHI VIDYA MANDIR          ",bg=X,fg=Y).pack()
        HSR=Label(Title,font=("futura",11,"bold"),text="HOSUR",bg=X,fg=Y).pack()
        ...
        Srch112.grid(row=1,column=0)
        Srch1112=Button(srchb,text="Search",font=("futura",18,"bold"),padx=5,command=lambda:[srchn1()])
        Srch1112.grid(row=1,column=1)
        go=Button(Butt,text="SETTINGS",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[Settings(Home1,X,Y)])
        go.grid(padx=10,pady=5,row=0,column=40)
        delete=Button(Butt,text="CLEAR",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[clear(),Home1.destroy(),Books(X,Y)])
        delete.grid(padx=10,pady=5,row=0,column=1)
        fst1=Button(Butt,text="ADD",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[sad(),Home1.destroy(),Books(X,Y)])
        fst1.grid(padx=10,pady=5,row=0,column=0)
        exi=Button(Butt,text="QUIT",font=("futura",19,"bold"),padx=5,pady=5,bd=10,bg="red",command=lambda:[qui()])
        exi.grid(padx=10,pady=5,row=0,column=500)
#=====================================================================BOOKRECORD_BACKEND====================================================================#
        def qui():
                exiit=messagebox.askyesno("EXIT","ARE YOU SURE YOU WANT TO QUIT")
                if(exiit>0):
                    Home1.destroy()
        fst=Button(Butt,text="CHANGE LOGIN",font=("futura",19,"bold"),padx=5,pady=5,bd=10,command=lambda:[Home1.destroy(),Login_selection(X,Y)])
        fst.grid(padx=10,pady=5,row=0,column=3)
        def sad():
            a1=BookName1.get()
            b1=BookCode1.get()
            c1=RollNo1.get()
